...
typedef enum levelOrderCommand
{
    ...
    CMD_LEVELORDER_SET,
    CMD_LEVELORDER_HALLFAME,
    CMD_LEVELORDER_HALLFAMEDIFFICULTIES,
    CMD_LEVELORDER_HALLFAMEDIFFICULTYCREDITS,
    CMD_LEVELORDER_HALLFAMEINITIALS,
    CMD_LEVELORDER_HALLFAMETIMES,
